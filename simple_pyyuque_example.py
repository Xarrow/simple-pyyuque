...
spyqa = SimplePyYuQueQuickAPI(token='LIpEyM947oR2ZjmEdgCd6ByKPQUlLd39UrrtXVlS',app_name="pyyuque")

class TestSimplePyYuQueQickAPI(object):
    def a(self):
        spyqa.create_group()
...
class TestPyYuQue(object):
    ...
    def post_groups(self):
        res = group_api.post_group(name='helixcs', login="Helixcs123",
...
'''
        res = repo_api.put_repos(name="myrepo",
                                 slug="myrepo",
                                 toc="",
                                 description="我的 REPO",
                                 public=RepoPublic.ALL_OPEN).base_response
